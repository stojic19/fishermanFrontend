...
export default {
  ...
  methods: {
    ...
    getAdventure: function () {
      ...
      axios
        .post(
          process.env.VUE_APP_BACKEND_URL + "adventures/findById",
          this.adventureDto
        )
        .then((response) => {
          this.addedAdditionalServices = [];
      ...
      axios
        .post(
          process.env.VUE_APP_BACKEND_URL +
            "reservationAdventure/makeReservation",
          {
            id: null,
    ...
    subscribe: function () {
      axios
        .post(
          process.env.VUE_APP_BACKEND_URL +
            "adventureSubscription/addSubscription",
          {
            adventureDto: this.adventureDto,
            clientUsername: this.email,
          },
    ...
    unsubscribe: function () {
      axios
        .post(
          process.env.VUE_APP_BACKEND_URL +
            "adventureSubscription/removeSubscription",
          {
            adventureDto: this.adventureDto,
            clientUsername: this.email,
          },
    ...
    deleteAdventure: function () {
      axios
        .post(
          process.env.VUE_APP_BACKEND_URL +
            "adventures/canBeEditedOrDeleted/" +
