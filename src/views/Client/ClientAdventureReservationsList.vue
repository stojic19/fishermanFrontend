      ...
      <div class="col">
        ...
        <div class="row">
          ...
          <div class="col-sm-9" style="padding: 1%">
            <Datepicker format="dd/MM/yyyy" v-model="startDate" disabled> </Datepicker>
          </div>
        </div>
        <br />
        <div class="row">
          ...
          <div class="col-sm-9" style="padding: 1%">
            <Datepicker format="dd/MM/yyyy" v-model="endDate" disabled></Datepicker>
          </div>
        </div>
        <div class="row">
          <div
    ...
    getImageUrl: function (index) {
      if (this.reservationsLoaded == true) {
        ...
        this.entityImages.forEach((image) => {
          if (image.fileName === this.sortedReservations[index].adventureDto.images[0].url) {
