...
export default {
  ...
  methods: {
    ...
    getAdventure: function () {
      axios
        .post(
          process.env.VUE_APP_BACKEND_URL + "adventures/findByName",
          this.adventureDto
        )
        .then((response) => {
    ...
    editProfile: function () {
      this.$router.push(
        "/editAdventure/" + this.email + "/" + this.adventureDto.name
      );
    },
    ...
    visitProfile: function (username) {
      ...
      this.$router.push(
        "/cabinOwner/viewProfile/" + this.email + "/" + username
      );
    },
    statistics: function () {
      this.$router.push(
        "/adventureStatistics/" + this.email + "/" + this.adventureDto.name
      );
    },
  },
};
